...
int main() {
    ...
    // 示例 1
    {
        ...
        int result = solution.minimumRightShifts(nums);
        check("示例1: nums=[3,4,5,1,2]", result, 2);
    }
    ...
    // 自定义: nums=[1,2,5,4]
    {
        ...
        int result = solution.minimumRightShifts(nums);
        check("自定义: nums=[1,2,5,4]", result, -1);
    }
